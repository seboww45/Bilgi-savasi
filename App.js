// App.js - PLAY STORE HAZIR TAM SÜRÜM
...
const PRIVACY_POLICY_URL = "https://green-priscella-53.tiiny.site/";
...
const STORAGE_KEYS = {
  ...
  USERS: 'users',
  DOUBLE_XP_STATE: 'doubleXPState',
  SETTINGS: 'settings',
  TURKEY_RANKING: 'turkeyRanking',
...
const TURKEY_RANKING = {
  ENTRY_FEE: 0,
  SEASON_DURATION: 60 * 24 * 60 * 60 * 1000, // 60 gün
  TOTAL_PLAYERS: 0,
  TOP_PLAYERS: 1,
  REWARDS: {
...
<body>
    <div class="last-updated">
        <strong>Güncel Gizlilik Politikası</strong>
    </div>

    <h1>GİZLİLİK POLİTİKASI</h1>
    
    <p>Aşağıdaki iframe'de güncel gizlilik politikamızı görüntüleyebilirsiniz:</p>
    
    <iframe src="${PRIVACY_POLICY_URL}"></iframe>
    
    <div class="contact-info">
        <h3>İletişim Bilgileri</h3>
        <p><strong>E-posta:</strong> ${SUPPORT_EMAIL}</p>
...
<body>
    <div class="last-updated">
        <strong>Son Güncelleme:</strong> 01 Ocak 2024
    </div>

    <h1>KULLANIM KOŞULLARI</h1>
    
    <div class="warning-box">
        <strong>ÖNEMLİ:</strong> Bilgi Savaşı uygulamasını ("Uygulama") indirerek, yükleyerek veya kullanarak bu Kullanım Koşulları'nı kabul etmiş sayılırsınız. Lütfen bu koşulları dikkatlice okuyun.
    </div>

    <h2>1. Kabul</h2>
    <p>Bu Uygulama'yı kullanmakla, bu Kullanım Koşulları'nın tüm hükümlerini kabul etmiş olursunuz. Kabul etmiyorsanız, lütfen Uygulama'yı kullanmayın.</p>

    <h2>2. Hizmet Tanımı</h2>
    <p>Bilgi Savaşı, kullanıcıların bilgi yarışması oynayabileceği, puan kazanabileceği ve diğer kullanıcılarla yarışabileceği bir mobil uygulamadır.</p>

    <div class="ad-section">
        <h3>Reklam Politikası</h3>
        <p>Uygulamamız Google Admob reklam ağını kullanmaktadır:</p>
        <ul>
            <li><strong>Banner Reklamlar:</strong> Uygulama alt kısmında sürekli görüntülenir</li>
            <li><strong>Ödüllü Reklamlar:</strong> İsteğe bağlı olarak 2x TP ve ekstra XP için izlenebilir</li>
            <li><strong>Geçiş Reklamları:</strong> Maç sonlarında gösterilir</li>
            <li><strong>Premium Üyelik:</strong> Tüm reklamları tamamen kaldırır</li>
        </ul>
        <p>Reklam gelirleri uygulamanın ücretsiz kalmasını ve geliştirilmesini sağlar.</p>
    </div>
    ...
    <ul>
        ...
        <li>Hesabınız üzerindeki tüm faaliyetlerden sorumlusunuz</li>
    </ul>
    ...
    <div class="prohibited">
        <ul>
            <li>Hile, bot veya otomasyon yazılımı kullanmak</li>
            <li>Sistemi manipüle etmeye yönelik girişimler</li>
            <li>Başka kullanıcıların hesaplarını ele geçirmeye çalışmak</li>
            <li>Uygulamanın güvenliğini tehdit eden eylemler</li>
            <li>Spam veya kötü niyetli içerik paylaşmak</li>
            <li>Telif hakkı ile korunan içerikleri izinsiz kullanmak</li>
            <li>Uygulamayı tersine mühendisliğe tabi tutmak</li>
            <li>Reklam engelleyici yazılım kullanmak</li>
        </ul>
    </div>

    <h2>5. Fikri Mülkiyet</h2>
    <p>Uygulamanın tüm içeriği (logo, tasarım, sorular, kod) telif hakkı ve diğer fikri mülkiyet kanunları ile korunmaktadır.</p>

    <h2>6. Premium Üyelik ve Ödemeler</h2>
    <ul>
        <li>Premium üyelik otomatik yenilenebilir aboneliktir</li>
        <li>Fiyat: 99,99₺/ay (KDV dahil)</li>
        <li>İptal işlemi App Store/Play Store üzerinden yapılmalıdır</li>
        <li>İade talepleri yasal haklar çerçevesinde değerlendirilir</li>
        <li>Premium üyelik tüm reklamları kaldırır ve bonuslar sağlar</li>
        <li>Ödemeler Apple/Google üzerinden işlenir</li>
    </ul>

    <h2>7. Türkiye Sıralaması</h2>
    <ul>
        <li>Katılım ücretsizdir</li>
        <li>Kontenjan sınırı yoktur</li>
        <li>Para ödülü yoktur, sadece unvan ve prestij ödülleri vardır</li>
        <li>Kurallara uymayanlar diskalifiye edilir</li>
    </ul>

    <h2>8. Garanti Reddi</h2>
    <p>Uygulama "olduğu gibi" sunulmaktadır. Performans, doğruluk veya kesintisiz hizmet garanti edilmez.</p>

    <h2>9. Sorumluluk Sınırlaması</h2>
    <p>Uygulama kullanımından doğan dolaylı, özel veya sonuç zararlarından sorumlu değiliz.</p>

    <h2>10. Hesap Askıya Alma ve Sonlandırma</h2>
    <p>Bu koşulları ihlal eden hesaplar uyarı yapılmaksızın askıya alınabilir veya sonlandırılabilir.</p>

    <h2>11. Hesap Silme</h2>
    <ul>
        <li>Hesap silme işlemi geri alınamaz</li>
        <li>Tüm verileriniz kalıcı olarak silinir</li>
        <li>Satın alımlar iade edilmez</li>
        <li>Hesap silme talebi uygulama içinden yapılabilir</li>
    </ul>

    <h2>12. Üçüncü Taraf Hizmetleri</h2>
    <p>Uygulama aşağıdaki üçüncü taraf hizmetleri kullanır:</p>
    <ul>
        <li>Google Admob (Reklamlar)</li>
        <li>Google Play Billing (Ödemeler)</li>
        <li>Apple App Store (Ödemeler)</li>
    </ul>

    <h2>13. Değişiklikler</h2>
    <p>Bu koşulları istediğimiz zaman değiştirme hakkını saklı tutarız. Değişiklikler uygulama içinde duyurulacaktır.</p>

    <h2>14. Uygulanacak Hukuk</h2>
    <p>Bu koşullar Türk hukukuna tabidir. Anlaşmazlıklarda İstanbul Mahkemeleri yetkilidir.</p>

    <div class="important">
        <h3>İletişim ve Şikayetler</h3>
        <p>Her türlü soru, şikayet veya talebiniz için bize ${SUPPORT_EMAIL} adresinden ulaşabilirsiniz.</p>
        <p><strong>Şikayet yanıt süresi:</strong> En geç 30 iş günü</p>
    </div>
</body>
</html>
`;
      ...
      return (
        <View style={styles.errorContainer}>
          ...
          <Text style={styles.errorText}>
            Uygulamada bir hata oluştu. Lütfen yeniden başlatın.
          </Text>
          <TouchableOpacity 
...
const AdManager = {
  ...
  initialize: async () => {
    try {
      ...
      console.warn('AdManager başlatma hatası:', error);
      return false;
    }
  },
  ...
  canShowInterstitial: function() {
    ...
    const now = Date.now();
    if (!this.lastAdShownTime || (now - this.lastAdShownTime) > this.AD_COOLDOWN) {
  ...
  showRewardedAd: async (adType = 'xp') => {
    if (AdManager.isPremium) {
      return new Promise((resolve) => {
        setTimeout(() => {
          const reward = adType === '2x' ? '2x_tp_30min' : 'extra_xp';
          resolve({ reward, amount: adType === '2x' ? 30 : 500 });
        }, 500);
      });
    }
    ...
    return new Promise((resolve, reject) => {
      Alert.alert(
        "🎁 ÖDÜLLÜ REKLAM",
        adType === '2x' 
          ? "30 dakika boyunca 2x TP kazanmak için reklam izlemek ister misiniz?"
          : "Ekstra XP kazanmak için reklam izlemek ister misiniz?",
        [
          { text: "İptal", style: "cancel", onPress: () => reject('cancelled') },
          { 
            text: "İzle ve Kazan", 
            onPress: () => {
              setTimeout(() => {
...
class DoubleXPSystem {
  ...
  static saveState = async () => {
    try {
      ...
      await AsyncStorage.setItem(STORAGE_KEYS.DOUBLE_XP_STATE, JSON.stringify(state));
    } catch (error) {
  ...
  static loadState = async () => {
    try {
      const stateStr = await AsyncStorage.getItem(STORAGE_KEYS.DOUBLE_XP_STATE);
...
// MAÇ MODLARI
const MATCH_MODES = {
  SOLO: { name: "Tekli", players: 1, multiplier: 1.0, questionCount: 10, icon: "👤", description: "Tek başına oyna" },
  PREMIUM: { name: "Premium Savaş", players: 1, multiplier: 2.0, questionCount: 20, premium: true, icon: "⭐", description: "Premium zorluk" }
};
  ...
  static async loadQuestions() {
    ...
    try {
      ...
      try {
        ...
        await AsyncStorage.setItem('questions_cache', JSON.stringify({
      ...
      try {
        const cache = await AsyncStorage.getItem('questions_cache');
        if (cache) {
          const { questions, timestamp } = JSON.parse(cache);
        ...
        console.warn('Cache yükleme hatası:', cacheError);
      }
...
class RealisticBot {
  static getAnswer(question, difficulty, timeLeft) {
    ...
    const timeFactor = timeLeft > 10 ? 1.0 : (timeLeft / 10);
    ...
    if (Math.random() < finalProbability) {
      ...
      if (Math.random() > 0.5 && wrongOptions.length > 1) {
        return Math.random() > 0.5 ? wrongOptions[0] : wrongOptions[wrongOptions.length - 1];
      } else {
...
const LoginModal = ({ visible, onClose, onLogin }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      onLogin(userData);
      NotificationManager.show("Hoş Geldiniz", `Merhaba ${username}!`);
      onClose();
    } catch (error) {
      console.warn('Giriş hatası:', error);
      ...
      <View style={styles.modalContainer}>
        <View style={styles.loginModalContent}>
          <Text style={styles.loginTitle}>
            🎮 BİLGİ SAVAŞI'NA HOŞ GELDİNİZ
          </Text>
          
          <Text style={styles.loginInfo}>
            Oynamak için sadece bir kullanıcı adı seçin
          </Text>
...
const TermsOfUseModal = ({ visible, onClose }) => (
  <Modal visible={visible} animationType="slide" transparent>
    <View style={styles.modalContainer}>
      <View style={styles.webViewModal}>
        <View style={styles.webViewHeader}>
          <Text style={styles.webViewTitle}>Kullanım Koşulları</Text>
          <TouchableOpacity 
            style={styles.webViewCloseButton}
            onPress={onClose}
          >
...
const SupportModal = ({ visible, onClose }) => {
  ...
  const handleSendEmail = async () => {
    ...
    const mailtoLink = `mailto:${SUPPORT_EMAIL}?subject=Bilgi Savaşı Uygulaması Desteği&body=${encodeURIComponent(message)}`;
      ...
      <View style={styles.modalContainer}>
        <View style={styles.supportModalContent}>
          ...
          <View style={styles.commonIssuesList}>
            <Text style={styles.commonIssue}>• Sorular yüklenmiyor: İnternet bağlantınızı kontrol edin</Text>
            <Text style={styles.commonIssue}>• Teknik sorunlar: Uygulamayı yeniden başlatın</Text>
            <Text style={styles.commonIssue}>• Premium sorunları: Ödeme onayı 24 saate kadar sürebilir</Text>
          </View>
  ...
  const handleDelete = () => {
    if (step === 1) {
      ...
      Alert.alert(
        ...
        "• Tüm verileriniz tamamen silinecek\n" +
          ...
          {step === 1 ? (
            <>
              ...
              <View style={styles.warningList}>
                ...
                <Text style={styles.warningItem}>• Tüm kişisel verileriniz tamamen silinir</Text>
...
const TurkeyRankingModal = ({ 
  ...
  return (
    <Modal visible={visible} animationType="slide" transparent>
      <View style={styles.modalContainer}>
        <ScrollView 
          style={styles.turkeyRankingScroll}
          showsVerticalScrollIndicator={false}
        >
          <View style={styles.turkeyRankingContent}>
            <View style={styles.turkeyRankingHeader}>
              ...
              <Text style={styles.turkeyRankingSubtitle}>
                Sezon {rankingData.currentSeason} • {timeLeft} kaldı
              </Text>
              ...
              {isParticipant && playerRank && (
                <View style={styles.playerRankBadge}>
                  ...
                  {playerRank === 1 && (
                    <Text style={styles.topPlayerBadge}>
                      ⭐ TÜRKİYE ŞAMPİYONU!
                    </Text>
                  )}
                </View>
            ...
            <View style={styles.rewardsSection}>
              ...
              <View style={styles.rewardsGrid}>
                <View style={[styles.rewardCard, styles.firstReward]}>
                  ...
                  <Text style={styles.freeEntryNote}>📢 HERKES KATILABİLİR • ÜCRETSİZ</Text>
                </View>
                
                <View style={styles.otherRewardsCard}>
                  ...
                  <Text style={styles.noContestNote}>
              ...
              {isParticipant ? (
                <View style={styles.alreadyJoinedContainer}>
                  ...
                  <View style={styles.playerStatsContainer}>
                    ...
                    {playerRank === 1 && (
                      <Text style={[styles.playerStat, { color: '#FFD700', fontWeight: 'bold' }]}>
                        ⭐ ŞU AN TÜRKİYE ŞAMPİYONU SUNUZ!
                      </Text>
                    )}
                  </View>
                </View>
            ...
            {showLeaderboard && rankingData.leaderboard && (
              <View style={styles.leaderboardSection}>
                ...
                <FlatList
                  data={rankingData.leaderboard.slice(0, 20)}
...
const PremiumModal = ({ visible, onClose, onPurchase, isPremium }) => {
  ...
  const premiumPlans = {
    monthly: {
      ...
      popular: true,
      productId: Platform.OS === 'ios' ? 'premium_monthly' : 'premium_monthly'
    }
  };
            ...
            {isPremium ? (
              <>
                ...
                <View style={styles.activePremiumContainer}>
                  ...
                  <Text style={styles.managementInfo}>
                    Aboneliğinizi yönetmek için {Platform.OS === 'ios' ? 'App Store' : 'Play Store'} hesabınıza gidin.
                  </Text>
                </View>
              </>
            ) : (
              <>
                ...
                <Text style={styles.paymentInfo}>
                  • Ödeme {Platform.OS === 'ios' ? 'App Store' : 'Play Store'} hesabınıza yansıtılır
                  • Aboneliği istediğiniz zaman iptal edebilirsiniz
                </Text>
              </>
            )}
...
const RewardsModal = ({ visible, onClose, onWatchAd, isPremium }) => {
  ...
  const handleWatchAd = async (reward) => {
    ...
    try {
      const result = await AdManager.showRewardedAd(reward.id === '2x_tp' ? '2x' : 'xp');
      
      if (result.reward === '2x_tp_30min') {
        onWatchAd('doubleXP', reward.duration);
        NotificationManager.show(
          "🎉 TEBRİKLER!",
          "30 dakika boyunca 2x TP aktif!"
        );
      } else if (result.reward === 'extra_xp') {
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <TouchableOpacity 
                ...
                onPress={() => !item.disabled && handleWatchAd(item)}
                disabled={item.disabled || selectedReward?.id === item.id}
              >
...
// MAÇ BİTİMİ ANİMASYONU
const MatchEndAnimation = ({ visible, result, onClose }) => {
  ...
  return (
    <View style={styles.animationOverlay}>
      ...
      <Animated.View style={[
        ...
        <Animated.Text style={[styles.animationTitle, {
          opacity: fadeAnim,
          color: result?.win ? '#FFD700' : '#ffa800'
        }]}>
          {result?.win ? '🎉 ŞAMPİYON! 🎉' : '💫 MAÇ SONUCU 💫'}
        </Animated.Text>
        
        <Animated.View style={[styles.statsContainerAnimation, {
          opacity: fadeAnim
        }]}>
          <View style={styles.statRow}>
            <Text style={styles.statLabel}>Doğru Sayısı:</Text>
          ...
          {result?.isDoubleXP && (
            <View style={styles.statRow}>
              <Text style={[styles.statLabel, { color: '#FFD700' }]}>⚡ 2x TP AKTİF!</Text>
              <Text style={[styles.statValue, { color: '#FFD700' }]}>
                {result?.bonusXPGained} bonus XP
              </Text>
            </View>
          )}
          ...
          {result?.isPremium && (
            <View style={styles.statRow}>
              <Text style={[styles.statLabel, { color: '#FFD700' }]}>⭐ PREMIUM BONUS</Text>
              <Text style={[styles.statValue, { color: '#FFD700' }]}>
                +%25 XP
              </Text>
            </View>
        ...
        <TouchableOpacity 
          style={[styles.continueAnimationButton, {
            backgroundColor: result?.win ? '#FFD700' : '#ffa800'
          }]}
          onPress={onClose}
        >
          <Text style={styles.continueAnimationButtonText}>
            {result?.win ? '🎉 DEVAM ET' : '💫 DEVAM ET'}
          </Text>
        </TouchableOpacity>
      </Animated.View>
    </View>
          ...
          <View style={styles.resultModalContent}>
            ...
            <View style={styles.resultStats}>
              <Text style={styles.resultStat}>
                Doğru Sayısı: {result?.correctAnswers}/{result?.totalQuestions}
              </Text>
              <Text style={styles.resultStat}>
              ...
              {result?.isDoubleXP ? (
                <>
                  <Text style={[styles.resultStat, { color: '#FFD700', fontWeight: 'bold' }]}>
                    ⚡ 2x TP AKTİF!
                  </Text>
                  <Text style={styles.resultStat}>
                    XP Kazancı: {result?.baseXPGained} + {result?.bonusXPGained} (Bonus)
                  </Text>
                  <Text style={styles.resultStat}>
                    Toplam XP: {result?.xpGained}
                  </Text>
                </>
              ) : (
                <Text style={styles.resultStat}>
                  Kazanılan XP: {result?.xpGained}
                </Text>
              )}
              ...
              <Text style={[styles.resultStat, { 
                ...
                {result?.scoreChange > 0 ? '+' : ''}{result?.scoreChange} puan
              </Text>
              <Text style={styles.resultStat}>
                Yeni Skor: {result?.newScore}
              </Text>
            </View>
...
const useGameStore = () => {
  const [state, setState] = useState({
    ...
    turkeyRanking: {
      ...
      seasonEndDate: new Date(Date.now() + TURKEY_RANKING.SEASON_DURATION).toISOString(),
      participants: [],
      leaderboard: [],
      pastSeasons: [
        {
          ...
          topPlayers: [
            { id: 999, name: "QuizMaster", rank: 1, score: 15200, prize: 0 },
            { id: 888, name: "BilgeKral", rank: 2, score: 14850, prize: 0 },
            { id: 777, name: "TürkBeyni", rank: 3, score: 14200, prize: 0 }
          ],
  ...
  const actions = useMemo(() => ({
    loginUser: (userData) => setState(prev => ({
      ...prev,
      playerProfile: { 
        ...prev.playerProfile,
        id: userData.id,
    ...
    deleteAccount: async () => {
      try {
        ...
        if (usersStr) {
          ...
          const updatedUsers = users.filter(u => u.username !== state.playerProfile.username);
          await AsyncStorage.setItem(STORAGE_KEYS.USERS, JSON.stringify(updatedUsers));
        }
        
        await AsyncStorage.removeItem(STORAGE_KEYS.CURRENT_USER);
      } catch (error) {
        console.warn('Hesap silme hatası:', error);
      }
    ...
    completeMatch: (matchData) => {
      setState(prev => {
        ...
        const newStats = {
          ...
          totalPlayTime: prev.gameStats.totalPlayTime + matchData.duration,
        };
        ...
        return {
          ...
          playerProfile: {
            ...prev.playerProfile,
            totalMatches: prev.playerProfile.totalMatches + 1,
            wins: isWin ? prev.playerProfile.wins + 1 : prev.playerProfile.wins,
            correctAnswers: prev.playerProfile.correctAnswers + matchData.correctAnswers,
            totalQuestions: prev.playerProfile.totalQuestions + matchData.totalQuestions
          }
        };
      });
    },
    ...
    completeMatchWithXP: (matchData) => {
      ...
      const accuracyBonus = (matchData.correctAnswers / matchData.totalQuestions) * 100;
      const comboBonus = matchData.combo * 10;
      const winBonus = matchData.win ? 200 : 50;
      
      let xpGained = Math.floor(
        (baseXP + accuracyBonus + comboBonus + winBonus) * xpMultiplier
      );
    ...
    completeSeason: () => {
      setState(prev => {
        ...
        const now = new Date();
        const seasonEndDate = new Date(now.getTime() + TURKEY_RANKING.SEASON_DURATION);
        ...
        return {
          ...
          turkeyRanking: {
            ...
            participants: [],
            leaderboard: [],
            pastSeasons: [pastSeason, ...prev.turkeyRanking.pastSeasons]
          },
          playerTurkeyStats: {
            isParticipant: false,
...
const App = () => {
  ...
  const animateOptionsIn = useCallback(() => {
    ...
    if (!currentQuestionData || !currentQuestionData.options || !optionAnimations.current) return;
    ...
    if (currentQuestion < currentQuestions.length - 1) {
      ...
      if (currentQ && selectedMode === "SOLO") {
        ...
        setTimeout(() => {
          ...
          const newOpponentAnswers = [...opponentAnswers];
          newOpponentAnswers[currentQuestion + 1] = botAnswer;
          setOpponentAnswers(newOpponentAnswers);
        }, responseTime);
      }
    } else {
      finishMatch();
    }
  }, [currentQuestion, currentQuestions.length, startQuestionTimer, animateOptionsIn, selectedMode, opponentAnswers, questionTimeLeft]);
  ...
  const finishMatch = useCallback(() => {
    ...
    const win = correctAnswers > opponentCorrectAnswers || (correctAnswers === opponentCorrectAnswers && Math.random() > 0.5);
  ...
  }, [correctAnswers, combo, selectedMode, playerScore, updateScore, completeMatchWithXP, playSound, showScoreChangeAnimation, currentQuestions.length, adWatched, playerProfile.isPremium, opponentAnswers, currentQuestions]);
  ...
  const answerQuestion = useCallback((optionIndex) => {
    ...
    const newOpponentAnswers = [...opponentAnswers];
    newOpponentAnswers[currentQuestion] = opponentAnswer;
    setOpponentAnswers(newOpponentAnswers);
    ...
    setTimeout(nextQuestion, 2000);
  }, [selectedOption, currentQuestion, opponentAnswers, playSound, nextQuestion, currentQuestions, questionTimeLeft]);
    ...
    try {
      ...
      if (selectedMode === "SOLO") {
        ...
        setTimeout(() => {
          ...
          const newOpponentAnswers = [...new Array(matchQuestions.length).fill(null)];
          newOpponentAnswers[0] = opponentAnswer;
          setOpponentAnswers(newOpponentAnswers);
        }, responseTime);
      }
    } catch (error) {
  ...
  }, [selectedMode, playSound, matchmakingAnim, startMatch, playerProfile.isPremium, playerProfile.isLoggedIn]);
  ...
  const handleWatchRewardedAd = async (rewardType, amount) => {
  ...
  const handlePurchasePremium = (planType) => {
  ...
  }, [playerProfile.doubleXPActive, playerProfile.doubleXPRemaining, playerProfile.isPremium, updateDoubleXP]);
      ...
      <View style={styles.modalContainer}>
        ...
        >
          ...
          <View style={styles.levelUpDisplay}>
            <Text style={styles.oldLevel}>Seviye {newLevel - 1}</Text>
            <Text style={styles.levelArrow}>→</Text>
            <Text style={styles.newLevel}>Seviye {newLevel}</Text>
          </View>
    ...
    return (
      ...
      >
        <View style={[
          ...
          { 
            backgroundColor: isPositive ? 'rgba(76, 175, 80, 0.9)' : 'rgba(244, 67, 54, 0.9)',
          ...
          <Text style={[
            ...
            {isPositive ? '+' : ''}{points} PUAN
          </Text>
          <Text style={styles.scoreAnimationSubtext}>
            {isPositive ? 'Kazandın!' : 'Kaybettin!'}
          </Text>
        </View>
      </Animated.View>
    );
    ...
    <View style={styles.screen}>
        ...
        <>
          ...
          >
            <View style={[styles.profileImageContainer, getFrameStyle(playerProfile.frame)]}>
              ...
              />
              {playerProfile.isPremium && <Text style={styles.premiumProfileBadge}>⭐</Text>}
            </View>
          </TouchableOpacity>
      ...
      <View style={styles.mainContent}>
        <View style={styles.logoContainer}>
          ...
          <Text style={styles.appSubtitle}>Competitive Quiz</Text>
          {playerProfile.isPremium && (
            <Text style={styles.premiumLogoBadge}>⭐ PREMIUM</Text>
          )}
        </View>
        ...
        {!playerProfile.isLoggedIn ? (
          <View style={styles.loginRequiredContainer}>
            <Text style={styles.loginRequiredTitle}>👋 Hoş Geldiniz!</Text>
            <Text style={styles.loginRequiredText}>
              Oynamak için giriş yapmanız gerekiyor.
            </Text>
            <TouchableOpacity 
              style={styles.loginRequiredButton}
              onPress={() => setShowLoginModal(true)}
            >
              <Text style={styles.loginRequiredButtonText}>GİRİŞ YAP</Text>
            </TouchableOpacity>
          </View>
        ) : (
          <>
            <View style={styles.statsContainer}>
              ...
              <View style={styles.statCard}>
                <Text style={styles.statNumber}>%{Math.round((gameStats.correctAnswers/gameStats.totalQuestions)*100)}</Text>
            ...
            <View style={styles.modeSelection}>
              ...
              <View style={styles.modeButtons}>
                <TouchableOpacity 
                  style={[styles.modeButton, selectedMode === "SOLO" && styles.activeModeButton]}
                ...
                <TouchableOpacity 
                  style={[styles.modeButton, styles.premiumModeButton, selectedMode === "PREMIUM" && styles.activePremiumModeButton]}
                  onPress={() => {
                    if (!playerProfile.isPremium) {
                      Alert.alert(
                        "Premium Gerekli",
            ...
            <TouchableOpacity 
              style={[styles.battleButton, playerProfile.isPremium && styles.premiumBattleButton]}
              onPress={startMatchmaking}
              disabled={matchFinding || questionsError}
            >
              <Text style={styles.battleButtonText}>
                {matchFinding ? "RAKİP BULUNUYOR..." : "BİLGİNİ GÖSTER"}
              </Text>
              {playerProfile.isPremium && <Text style={styles.premiumBattleBadge}>⭐</Text>}
            </TouchableOpacity>
            ...
            {matchFinding && (
              <View style={styles.matchmakingInfo}>
                ...
                />
                <Text style={styles.matchmakingText}>Gerçek kullanıcı aranıyor...</Text>
              </View>
            )}
          </>
        )}
      ...
      <View style={styles.matchScreen}>
        <View style={styles.matchHeader}>
          ...
          <View style={styles.timerContainer}>
            ...
            <Text style={styles.questionCount}>SORU {currentQuestion + 1}/{currentQuestions.length}</Text>
          </View>

          <View style={styles.playerInfo}>
            <Text style={styles.playerName}>
              {opponent?.name || "Rakip"} {opponent?.isPremium && '⭐'}
            </Text>
        ...
        <View style={styles.progressComparison}>
          <View style={styles.progressBarPlayer}>
            <View style={[
              styles.progressBarPlayerFill,
              { width: `${(correctAnswers / (currentQuestion + 1)) * 100}%` }
            ]} />
            <Text style={styles.progressTextSmall}>
              {correctAnswers} Doğru
            </Text>
          </View>
          <View style={styles.progressBarOpponent}>
            <View style={[
              styles.progressBarOpponentFill,
              { width: `${(opponentCorrectAnswers / (currentQuestion + 1)) * 100}%` }
            ]} />
            <Text style={styles.progressTextSmall}>
              {opponentCorrectAnswers} Doğru
            </Text>
          </View>
        </View>
            ...
            {currentQ.options.map((option, index) => (
              <Animated.View
                ...
                style={[
                  ...
                  {
                    transform: [{
                      scale: (optionAnimations.current[index] || new Animated.Value(0)).interpolate({
                        inputRange: [0, 1],
                        outputRange: [0.8, 1]
                      })
                    }]
              ...
              >
                ...
                >
                  ...
                  {showResult && opponentAnswers[currentQuestion] === index && (
                    <Text style={styles.opponentChoiceIndicator}>👤</Text>
                  )}
                </TouchableOpacity>
              </Animated.View>
            ))}
        ...
        {combo >= 2 && (
          <View style={styles.comboContainer}>
            ...
            {playerProfile.isPremium && <Text style={styles.premiumComboBadge}>⭐</Text>}
          </View>
        )}
        ...
        <ScrollView style={styles.profileScroll}>
          <View style={styles.profileCard}>
            <View style={[styles.profileImageContainerLarge, getFrameStyle(playerProfile.frame)]}>
              ...
              />
              {playerProfile.isPremium && <Text style={styles.premiumProfileBadgeLarge}>⭐</Text>}
            </View>
            <Text style={styles.profileName}>{playerProfile.username}</Text>
            <Text style={styles.profileTitle}>"{playerProfile.title}" {playerProfile.isPremium && '⭐'}</Text>
            <Text style={styles.profileScore}>{playerScore} PUAN • Seviye {playerProfile.level}</Text>
            ...
            {playerTurkeyStats.isParticipant && (
              <View style={styles.turkeyRankingStatus}>
                ...
                {playerTurkeyStats.currentSeason.rank === 1 && (
                  <Text style={[styles.turkeyRankingStatusSubtext, { color: '#FFD700', fontWeight: 'bold' }]}>
            ...
            <View style={styles.profileStats}>
              ...
              <View style={styles.profileStat}>
                <Text style={styles.profileStatNumber}>%{Math.round((gameStats.correctAnswers/gameStats.totalQuestions)*100)}</Text>
            ...
            <View style={styles.unlockedSection}>
              ...
              <Text style={styles.unlockedText}>
                Premium Durumu: {playerProfile.isPremium ? 'AKTİF ⭐' : 'PASİF'}
              </Text>
              <Text style={styles.unlockedText}>
                Toplam Reklam: {gameStats.adsWatched}
              </Text>
              <Text style={styles.unlockedText}>
                Geçiş Reklamları: {gameStats.interstitialAdsShown}
              </Text>
              <Text style={styles.unlockedText}>
                Ödüllü Reklamlar: {gameStats.rewardedAdsWatched}
              </Text>
              <Text style={styles.unlockedText}>
                2x TP Durumu: {isDoubleXPActive ? `Aktif ${isDoubleXPPermanent ? '(SÜREKLİ ⭐)' : `(${Math.floor(doubleXPRemaining / 60)}:${String(doubleXPRemaining % 60).padStart(2, '0')})`}` : 'Pasif'}
              </Text>
              {playerProfile.isPremium && (
                <>
                  <Text style={[styles.unlockedText, { color: '#FFD700' }]}>
                    Premium Bonus: +%25 XP Kazancı
                  </Text>
                  <Text style={[styles.unlockedText, { color: '#FFD700' }]}>
                    Reklamsız Deneyim: AKTİF ⭐
                  </Text>
                  <Text style={[styles.unlockedText, { color: '#FFD700' }]}>
                    Premium Savaş Modu: AKTİF
                  </Text>
                </>
              )}
              {playerTurkeyStats.isParticipant && (
                <>
                  <Text style={[styles.unlockedText, { color: '#FF0000' }]}>
                    🏆 Türkiye Sıralaması: AKTİF
                  </Text>
                  <Text style={styles.unlockedText}>
                    Mevcut Sıralama: {playerTurkeyStats.currentSeason.rank || "Hesaplanıyor"}
                  </Text>
                  <Text style={styles.unlockedText}>
                    En İyi Sıralama: {playerTurkeyStats.bestRank || "-"}
                  </Text>
                  <Text style={styles.unlockedText}>
                    Katılımcı Sayısı: {turkeyRanking.participants?.length || 0} kişi
                  </Text>
            ...
            {!playerProfile.isPremium && (
              <TouchableOpacity 
                ...
                onPress={() => setShowPremiumModal(true)}
              >
                <Text style={styles.goPremiumProfileButtonText}>⭐ PREMIUM'A GEÇ (99,99₺/ay)</Text>
                <Text style={styles.goPremiumProfileSubtext}>Reklamsız deneyim ve daha fazla bonus!</Text>
              </TouchableOpacity>
            )}
        ...
        renderItem={({ item, index }) => (
          <View style={[
            ...
            <Text style={[
              ...
              item.isRank1 && styles.rank1Number,
              item.isPremium && styles.premiumRankNumber
            ]}>
              {index + 1}
            </Text>
            <View style={[styles.leaderboardAvatarContainer, getFrameStyle(item.frame)]}>
              ...
              {item.isPremium && <Text style={styles.premiumLeaderboardBadge}>⭐</Text>}
            </View>
            <View style={styles.leaderboardInfo}>
              <Text style={[
                ...
                item.isPremium && styles.premiumPlayerName
              ]}>
                {item.name} {item.name === playerProfile.username && "(Siz)"}
                {item.isRank1 && " 👑"}
                {item.isPremium && " ⭐"}
              </Text>
    ...
    <View style={styles.screen}>
      ...
      <ScrollView style={styles.settingsContainer}>
        <View style={styles.settingItem}>
          ...
          >
            <Text style={styles.toggleText}>{settings.soundEnabled ? "AÇIK" : "KAPALI"}</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.settingItem}>
          ...
          >
            <Text style={styles.toggleText}>{settings.vibration ? "AÇIK" : "KAPALI"}</Text>
          </TouchableOpacity>
        </View>
        ...
        >
          <Text style={styles.dangerButtonText}>🗑️ Hesabımı Sil</Text>
        </TouchableOpacity>
        ...
        >
          <Text style={styles.premiumSettingButtonText}>
            {playerProfile.isPremium ? '⭐ PREMIUM AYARLARI' : '⭐ PREMIUM SATIN AL (99,99₺/ay)'}
          </Text>
        </TouchableOpacity>
        ...
        >
          <Text style={styles.turkeyRankingSettingButtonText}>
            🏆 TÜRKİYE SIRALAMASI (ÜCRETSİZ • HERKES KATILABİLİR)
          </Text>
        </TouchableOpacity>
        ...
        {playerProfile.isLoggedIn && (
          <TouchableOpacity 
            ...
            onPress={handleLogout}
          >
            <Text style={styles.dangerButtonText}>🚪 ÇIKIŞ YAP</Text>
          </TouchableOpacity>
        )}
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  animationMainContent: {
    backgroundColor: 'rgba(16, 30, 56, 0.95)',
    padding: 30,
    borderRadius: 20,
    alignItems: 'center',
    width: '90%',
